...
export default function VideoProductionStats() {
  const t = useTranslations("videoProduction");

  const stats = [
    {
      target: 10,
      suffix: t("stats.viewsSuffix"),
      label: t("stats.viewsLabel"),
    },
    {
      target: 1000,
      suffix: t("stats.minutesSuffix"),
      label: t("stats.minutesLabel"),
    },
    {
      target: 10,
      suffix: t("stats.leadsSuffix"),
      label: t("stats.leadsLabel"),
    },
  ];
